...
const Header = () => {
  return (
    <View style={styles.headerContainer}>
      ...
      <Text>Requirement Engineer || Mobile Application developer</Text>
...
const Contact = () => {
  return (
    <View style={styles.contactContainer}>
      <Text>House # B-85, Gulistan Colony, WahCantt</Text>
      <Text>Mobile: 03225425081</Text>
      <Text>Email: saadbhai8760@gmail.com</Text>
      <Text onPress={() => Linking.openURL('https://github.com/muhammadsaad023/MAD')}>GitHub:github.com/muhammadsaad023</Text>
...
const Summary = () => {
  return (
    <View style={styles.sectionContainer}>
      ...
      <Text>Muhammd Saad | Software Quality Engineer | Comsats Institute of Information and Technology, Attock City, Pakistan</Text>
